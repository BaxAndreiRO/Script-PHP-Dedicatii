...
<head>
<title>Radio <?php nume_radio; ?> - Dedicatii LIVE - Dedicatiile sunt <?php if(status_dedicatii) { echo 'pornite'; } else { echo 'oprite'; } ?>.</title>
<meta charset="utf-8">
...
if(isset($_POST['pentru']) && isset($_POST['dela']) && isset($_POST['mesaj'])) {
  //require_once('adauga_dedicatia_in_db.php');
} else {
...
<div class="btn-group-vertical">
    <a style="margin-bottom:6px;margin-right:6px;" href="#admin_link" target="_blank" class="btn btn-default">Panou de Administrare</a>
</div>
</div>
