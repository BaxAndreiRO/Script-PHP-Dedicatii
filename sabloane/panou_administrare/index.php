...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h3 class="panel-title">Bun venit in panoul de administrare, <?php echo $utilizator; ?>.</h3>
  </div>
  <div class="panel-body">

<img src="<?php echo obtine_avatar_utilizator(); ?>" class="img-responsive img-thumbnail" align="left" width="100px" style="border-radius:5px; margin-right:5px; margin-botton:3px;"> Salutare <?php echo $utilizator; ?> si bun venit pe pagina principala de administrare a radioului <?php echo nume_radio; ?>.
